...
export class MyScene extends Phaser.Scene {
  ...
  preload() {
    ...
    this.load.spritesheet(
      'hurtBossSheet',
      'assets/sprites/Boss/Pirata/spritsheetHurtBoss.png',
      {
        frameWidth: 140,
        frameHeight: 96,
        startFrame: 0,
    ...
    this.load.spritesheet(
      'deathBossSheet',
      'assets/sprites/Boss/Pirata/spritsheetDeathBoss.png',
      {
        frameWidth: 140,
        frameHeight: 96,
        startFrame: 0,
    ...
    this.load.spritesheet(
      'attackBossSheet',
      'assets/sprites/Boss/Pirata/spritsheetAttackBoss.png',
      {
        frameWidth: 140,
        frameHeight: 96,
        startFrame: 0,
    ...
    this.load.spritesheet(
      'staticBossSheet',
      'assets/sprites/Boss/Pirata/spritsheetIdleBoss.png',
      {
        frameWidth: 140,
        frameHeight: 96,
        startFrame: 0,
    ...
    for (let i = 1; i <= 6; i++) {
      this.load.image(
        `background${i}`,
        `assets/scenerys/cenariopirata/part${i}.jpg`
      );
    }
  }
